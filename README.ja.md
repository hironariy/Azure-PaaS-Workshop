...
| 4 | [Day 1: PaaS インフラをデプロイ](materials/docs/learner/day-1-deploy-infrastructure.ja.md) | Bicep 標準 mode、Static Web Apps Standard、App Service、DocumentDB、Key Vault |
| 5 | [Day 1: バックエンドをデプロイ](materials/docs/learner/day-1-deploy-backend.ja.md) | Cloud Shell 上で backend を build し、App Service に ZIP deploy |
| 6 | [Day 1: フロントエンドをデプロイ](materials/docs/learner/day-1-deploy-frontend.ja.md) | Cloud Shell 上で React build、runtime config 注入、Static Web Apps deploy |
| 7 | [Day 1: アプリを検証](materials/docs/learner/day-1-validation.ja.md) | `/health`、`/api/health`、サインイン、CRUD、初期テレメトリ確認 |
